...
% Compare linear and nonlinear responses using the numerically
% calculated trim and linearised 4DOF model.
...
saveas(gcf, 'AutoLinearised_Velocity_Perturbations.png');
...
saveas(gcf, 'AutoLinearised_Position_Heading_Perturbations.png');
